...
[![npm version](https://img.shields.io/npm/v/munin-mcp?color=cb3837&logo=npm)](https://www.npmjs.com/package/munin-mcp)
[![npm downloads](https://img.shields.io/npm/dm/munin-mcp?color=cb3837&logo=npm)](https://www.npmjs.com/package/munin-mcp)
[![License: AGPL-3.0](https://img.shields.io/badge/license-AGPL--3.0-blue)](./LICENSE)
[![Node](https://img.shields.io/badge/node-%E2%89%A520-339933?logo=node.js&logoColor=white)](https://nodejs.org)
[![MCP server](https://img.shields.io/badge/MCP-server-8A2BE2)](https://modelcontextprotocol.io)

> Runs on your machine, with your own model — no Munin server, nothing to sign up for.
> If it's useful, a ⭐ helps other people find it.

<!--
  TODO before announcing: record a ~15s terminal+client demo and drop it here.
  The shot that converts: `munin add` a folder → restart Claude → ask a question →
  Claude answers with a citation you can click. A GIF/MP4 at the top of the README
  is the single biggest lever on stars. Tools: asciinema (terminal) or a screen
  recording trimmed to <20s, hosted in-repo under docs/ or as a release asset.
-->
<!-- ![Munin demo: drop a folder → ask Claude → cited answer](docs/demo.gif) -->
