...
Corpus: **brutal** · Reranker: **cross-encoder (BAAI/bge-reranker-v2-m3)** · rerank 45 calls, mean **59693ms/call**
...
Of 12 @24 misses: **12 are in the wide @200 pool but ranked out (RANKING problem → reranker)** · 0 are not in the pool at all (RECALL problem → ef_search / hybrid / embedding / corpus realism).
...
Total: £0.61 (1454 calls). Embedding £0.02, extraction £0.59, query/gen £0.00.
