...
Corpus: **brutal** · Reranker: **llm-judge (claude-sonnet-4-6)** · rerank 45 calls, mean **1371ms/call**
...
|---|---|---|---|
| simple-retrieval | 28 | recall@24 (any expected doc) | 79% |
...
Of 6 @24 misses: **6 are in the wide @200 pool but ranked out (RANKING problem → reranker)** · 0 are not in the pool at all (RECALL problem → ef_search / hybrid / embedding / corpus realism).
...
Total: £1.64 (1451 calls). Embedding £0.02, extraction £0.59, query/gen £1.03.
